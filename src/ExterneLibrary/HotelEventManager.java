...
public class HotelEventManager implements Runnable {
    ...
    /**
     * List of listeners to notify of a new ExterneLibrary.HotelEvent
     */
    ...
    public HotelEventManager() {
        ...
        events.add(new HotelEvent(HotelEventType.CHECK_IN, "", 20, new HashMap<String, String>() {{
            put("People.guest: 14", "4 stars");
        }}));
        events.add(new HotelEvent(HotelEventType.GOTO_FITNESS, "", 25, new HashMap<String, String>() {{
            put("People.guest: 14", "15 HTE");
        }}));

        events.add(new HotelEvent(HotelEventType.CHECK_IN, "", 20, new HashMap<String, String>() {{
            put("People.guest: 15", "4 stars");
        }}));
    ...
    /**
     * Registers a ExterneLibrary.HotelEventListener to the EventManager
     * @param listener
    ...
    /**
     * Deregisters a existing ExterneLibrary.HotelEventListener from the EventManager
     *
     * @param listener
